...
class UI : public QWidget, public Subject {
private:
...
public:
    ...
    UI(ServiceCRUD& s1, ServiceStatistics& s2, ServiceReteta& s3) : QWidget{}, Subject{} , serviceReteta{s3}, serviceStatistics{s2}, serviceCRUD{s1} {
