...
public:
    ...
    [[nodiscard]] int getNrMedicamente() const;

    [[nodiscard]] const vector<Medicament>& getMedicamente() const;
    ...
    [[nodiscard]] const Medicament& cautaMedicament(const string& denumire, const string& producator, const string& substantaActiva, double pret) const;

    [[nodiscard]] const Medicament& cautaMedicamentDenumire(const string& denumire) const;

    [[nodiscard]] int cautaMedicamentIndice(const string &denumire, const string &producator, const string &substantaActiva, double pret) const;

    [[nodiscard]] const Medicament& getMedicament(int index) const;

    void interschimbareMedicamente(int i, int j);

    [[nodiscard]] const map<string, int>& getContor() const noexcept;
