...
import com.example.myfirstapp.todo.utils.AccelerometerSensor
import com.example.myfirstapp.todo.utils.MyNetworkStatus
import com.example.myfirstapp.todo.utils.MyNotifications
...
@Composable
fun MyApp(networkStatus: @Composable () -> Unit, content: @Composable () -> Unit, sensor: @Composable () -> Unit) {
