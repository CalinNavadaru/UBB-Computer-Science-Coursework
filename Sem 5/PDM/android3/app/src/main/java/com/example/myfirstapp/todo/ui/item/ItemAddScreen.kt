...
fun ItemAddScreen(itemId: String?, onClose: () -> Unit) {
    ...
    var on_field by rememberSaveable { mutableStateOf(false) }


    Log.d("ItemAddScreen", "recompose, text = $first_name")
    ...
    Scaffold(
        topBar = {
            TopAppBar(title = { Text(text = "Add Employee") },
                actions = {
                    Button(onClick = {
        ...
        Column(
            ...
            Column {
                ...
                Row {
                    ...
                    Log.d(TAG, "formatting date_join....");
